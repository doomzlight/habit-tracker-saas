  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      const extractedFirstName =
        typeof userData.user.user_metadata?.first_name === "string"
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-slate-950 to-slate-900 text-slate-100">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-10">
        <header className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-slate-900/40 backdrop-blur">
          ...
          <div className="mt-4 overflow-hidden rounded-2xl border border-white/10 bg-linear-to-r from-cyan-500/15 via-blue-500/10 to-purple-500/15 p-5 shadow-xl shadow-cyan-500/10">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="text-sm text-slate-200/80">
                  Ready to make progress this {monthLabel}? Keep stacking those wins.
                </p>
              </div>
              <div className="flex items-center gap-2 rounded-full bg-white/10 px-3 py-2 text-sm font-semibold text-slate-100">
